...
namespace Wcs.App.Plugins.TaskManager
{
    public partial class frmMain : Form
    {
        ...
        private void paging1_EventPaging(EventArgs e)
        {
            ...
            {
                MessageBox.Show(string.Format("数据加载失败。{0}", ex.Message), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
                //WcsContext.Application.Logger.Error1(ex, this);
            }
        }

        private void onTaskEndLocationChanged(TaskEndLocationChangedEvent args)
        {
            try
            {
                if (this.InvokeRequired)
                {
                    Action<TaskEndLocationChangedEvent> act = (_args) =>
                    {
                        onTaskEndLocationChanged(_args);
                    };
                ...
                else
                {
                    ...
                    task.EndLocation = args.EndLocation;
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            {
                //WcsContext.Application.Logger.Error1(ex, this);
                MessageBox.Show(string.Format("任务数据加载失败：{0}", ex.Message), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }
        ...
        void load()
        {
            ...
            {
                paging1.TotalCount = unitOfWork.session.Query<Task>().Count();
        ...
        void onTaskAdded(TaskAddedEvent args)
        {
            try
            {
                ...
                else
                {
                    ...
                    //20231209升级分页后需要判断能不能直接增加到显示列表
                    //if (paging1.CurrentPage == paging1.PageCount && tasks.Count() < paging1.PageSize)
                    if (_bindingSource.Count < paging1.PageSize)
                    {
                        _bindingSource.Add((Task)args.Task);
                        ++paging1.QueryCount;
                    }
        ...
        private void tsmiArchive_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show(msg, Application.ProductName, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) != System.Windows.Forms.DialogResult.Yes)
                {
                    return;
                }
            ...
            {
                //WcsContext.Application.Logger.Error1(ex, this);
                MessageBox.Show(string.Format("任务删除失败：{0}", ex.Message), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }
        ...
        private void tsmiSuspend_Click(object sender, EventArgs e)
        {
            ...
            {
                //WcsContext.Application.Logger.Error1(ex, this);
                MessageBox.Show(string.Format("任务暂停失败：{0}", ex.Message), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }
        ...
        private void tsmiCancel_Click(object sender, EventArgs e)
        {
            ...
            {
                //WcsContext.Application.Logger.Error1(ex, this);
                MessageBox.Show(string.Format("任务取消失败：{0}", ex.Message), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }
        ...
        private void tsmiComplete_Click(object sender, EventArgs e)
        {
            ...
            {
                //WcsContext.Application.Logger.Error1(ex, this);
                MessageBox.Show(string.Format("任务强制完成失败：{0}", ex.Message), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }

        [Wcs.Security.WcsPermission(System.Security.Permissions.SecurityAction.Demand, OperationName = "任务管理\\当前任务\\优先级调整")]
        private void toolStripMenuItem_priority_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("请检查是否为双伸堆垛机的远端任务，确认修改！", " 友情提示", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1) == DialogResult.OK)
            {
        ...
        private void updateTasksPriority(Int32 priority)
        {
            ...
            {
                //WcsContext.Application.Logger.Error1(ex, this);
                MessageBox.Show(string.Format("更改任务优先级失败：{0}", ex.Message), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }
        ...
        [Wcs.Security.WcsPermission(System.Security.Permissions.SecurityAction.Demand, OperationName = "任务管理\\当前任务\\手动引发任务状态变化事件")]
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                //WcsContext.Application.Logger.Error1(ex, this);
                MessageBox.Show(string.Format("引发任务状态改变事件失败：{0}", ex.Message), Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }
        ...
        [Wcs.Security.WcsPermission(System.Security.Permissions.SecurityAction.Demand, OperationName = "任务管理\\当前任务\\刷新任务列表")]
