...
$itemArray="Wcs.App.Plugins.Debugger.dll","Wcs.App.Plugins.Debugger.pdb"
...
$project.Object.References | where { $_.Name -eq 'Wcs.App.Plugins.Debugger' } | foreach { $_.Remove() }