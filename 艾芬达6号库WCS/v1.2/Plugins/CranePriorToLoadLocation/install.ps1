...
$itemArray="Plugins.CranePriorToLoadLocation.dll","Plugins.CranePriorToLoadLocation.pdb"
...
$project.Object.References | where { $_.Name -eq 'Plugins.CranePriorToLoadLocation' } | foreach { $_.Remove() }