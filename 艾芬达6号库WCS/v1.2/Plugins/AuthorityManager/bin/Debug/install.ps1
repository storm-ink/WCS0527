...
$itemArray="Wcs.App.Plugins.AuthorityManager.dll","Wcs.App.Plugins.AuthorityManager.pdb"
...
$project.Object.References | where { $_.Name -eq 'Wcs.App.Plugins.AuthorityManager' } | foreach { $_.Remove() }