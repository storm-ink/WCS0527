...
namespace CraneService.TwoForksCrane
{
    ...
    public interface ITwoForksCraneService
    {
        ...
        /// <param name="userColumn">目的列位置(用户列)</param>
        /// <param name="userLevel">目的层位置(用户层)</param>
        /// <param name="forkDirection">货叉方向</param>
        /// <remarks>执行移动到指定位置的命令</remarks>
        [OperationContract]
        void MoveByForkDirection(string craneName, string userName, string ipAddress, int userColumn, int userLevel, Wcs.DefaultImpls.Crane.ForkDirection forkDirection);
        ...
        /// <param name="userLevel">目的层位置(用户层)</param>
        /// <param name="forkDirection">货叉方向</param>
        /// <param name="alignToFork1">指示是否将货叉1对齐到指定的位置</param>
        /// <remarks>执行移动到指定位置的命令</remarks>
        [OperationContract]
        void MoveByForkDirectionAndFork(string craneName, string userName, string ipAddress, String userCode, Boolean alignToFork1);
        ...
        [OperationContract]
        void Pick(string craneName, string userName, string ipAddress, Wcs.DefaultImpls.Crane.ForkDirection? fork1Direction, Wcs.DefaultImpls.Crane.ForkDirection? fork2Direction);
        ...
        [OperationContract]
        void Putdown(string craneName, string userName, string ipAddress, Wcs.DefaultImpls.Crane.ForkDirection? fork1Direction, Wcs.DefaultImpls.Crane.ForkDirection? fork2Direction);
