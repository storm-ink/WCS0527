...
{
    [WcsPluginInfo(typeof(RoleManagerPlugin), "权限管理", "Sineva", "2022年6月", "", true, "权限管理", "角色管理", 4, 0, 1)]
    public class RoleManagerPlugin : Wcs.WcsPlugin
    {
        ...
        [Wcs.Security.WcsPermission(System.Security.Permissions.SecurityAction.Demand, OperationName = "权限管理\\角色管理\\角色管理")]
        private void tsmi_Click(object sender, ItemClickEventArgs e)
        {
            try
            {
                this.Context.Application.MainForm.OpenNewForm<frmRoles>("角色管理");
            }
