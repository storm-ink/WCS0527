...
$itemArray="Plugins.EquipmentActionSchedulerManager.dll","Plugins.EquipmentActionSchedulerManager.pdb"
...
$project.Object.References | where { $_.Name -eq 'Plugins.EquipmentActionSchedulerManager' } | foreach { $_.Remove() }