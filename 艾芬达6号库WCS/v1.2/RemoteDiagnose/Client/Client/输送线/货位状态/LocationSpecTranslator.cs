...
{
    public class LocationSpecTranslator : ISpecificationTranslator<Location, Int32>
    {
        public IQueryable<Location> ApplyWhere(IQueryable<Location> q, ISpecification spec)
        {
            var specification = (LocationSpec)spec;
            ...
            {
                q = q.Where(x => x.Status == specification.State.Value);
            }
