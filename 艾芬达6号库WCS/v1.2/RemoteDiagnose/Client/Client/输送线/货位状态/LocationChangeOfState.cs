...
namespace Client.Conveyor
{
    ...
    /// </summary>
    public class LocationChangeOfState:Spiral.IAggregateRoot<Int32>
    {
        public LocationChangeOfState()
        {
        ...
        /// 状态A
        /// </summary>
        public virtual LocationStatus StateA { get; set; }
        /// <summary>
        /// 状态B
        /// </summary>
        public virtual LocationStatus StateB { get; set; }
        /// <summary>
        /// 开始时间
        /// </summary>
