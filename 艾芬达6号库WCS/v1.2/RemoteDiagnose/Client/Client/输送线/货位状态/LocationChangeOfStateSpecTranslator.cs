...
{
    public class LocationChangeOfStateSpecTranslator : ISpecificationTranslator<LocationChangeOfState, Int32>
    {
        public IQueryable<LocationChangeOfState> ApplyWhere(IQueryable<LocationChangeOfState> q, ISpecification spec)
        {
            var specification = (LocationChangeOfStateSpec)spec;
