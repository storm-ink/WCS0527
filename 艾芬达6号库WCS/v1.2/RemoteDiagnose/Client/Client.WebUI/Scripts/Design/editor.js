...
function addJSShuttleAdapter() {
    ...
    var shuttleDataAdapter = new Kinetic.JSShuttleDataAdapter({
        x: layer.getWidth() / 2,
        y: layer.getHeight() / 2,
        width: 50,
        height: 50,
    ...
    formatJSShuttleAdapter(shuttleDataAdapter);

    layer.add(shuttleDataAdapter);

    layer.draw();

    window.stage.setCurrentElement(shuttleDataAdapter);
}

function formatJSShuttleAdapter(shuttleDataAdapter) {
    shuttleDataAdapter.on('click', function () {
        window.stage.setCurrentElement(this);
    });
    shuttleDataAdapter.on('dragmove', function () {
        window.stage.setCurrentElement(this);
    });
    shuttleDataAdapter.setDraggable(true);
}
